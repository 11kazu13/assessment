...
function test1() {
  ...
  //太郎
  console.log('太郎');
  console.assert(assessment('太郎') === '太郎のいいところはユニークさです。太郎だけのその特徴が皆を楽しくさせます。',
  ...
  //花子
  console.log('花子');
  console.assert(assessment('花子') === '花子のいいところは情熱です。花子の情熱に周りの人は感化されます。',
    '診断結果の文言の特定の部分を名前に置き換える処理が正しくありません。');
...
//テストを行う関数2
function test2() {
  console.log('同じ名前なら同じ結果を出すテスト開始');
  ...
  console.log('同じ名前なら同じ結果を出すテスト終了');
}
